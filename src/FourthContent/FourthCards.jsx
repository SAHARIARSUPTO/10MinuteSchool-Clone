...
const FourthCards = () => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-3   pb-20'>
            <div className='p-5 border border-gray-300  mx-auto'>
                ...
                <p className='text-xl font-bold sm:text-xl'>HSC 25 অনলাইন ব্যাচ</p>
            ...
            <div className='p-5 border border-gray-300  mx-auto'>
                ...
                <p className='text-xl font-bold sm:text-xl'>HSC 24 ক্র্যাশ কোর্স-১ম পত্র</p>
            ...
            <div className='p-5 border border-gray-300  mx-auto'>
                ...
                <p className='text-xl font-bold sm:text-xl'>HSC 24 ক্র্যাশ কোর্স-২য় পত্র</p>
                <p className='text-xl text-success'>BDT 2500</p>
            </div>
        </div>
    );
