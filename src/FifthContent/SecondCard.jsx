...
const SecondCard = () => {
    return (
        <div>
            <div className='grid grid-cols-1 sm:grid-cols-3  rounded-xl  pb-20'>
            <div className='  bg-slate-800  mx-auto mb-5'>
            ...
            <div className='  bg-slate-800  mx-auto rounded-xl mb-5'>
...
<p className='text-xl font-bold  text-white'>HSC 24 ক্র্যাশ কোর্স-১ম পত্র</p>
        ...
        <div className='text-center justify-center pt-20 pb-20 mb-5'>
